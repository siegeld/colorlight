...
pub fn packet2hub75(data: &[u8]) -> Result<(usize, impl Iterator<Item = u32> + '_), ()> {
    ...
    let iter = data[HEADER_LEN..HEADER_LEN + length]
        ...
        .map(|c| {
            ...
            // 0x00GGRRBB -- this packed 0x00BBGGRR, so every Art-Net colour
            // came out with red and blue swapped. The v1.10.1 colour-order fix
            // corrected patterns.rs and bitmap_udp.rs and missed this file.
